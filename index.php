...
<body>
        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li class="scroll-to-section"><a href="#testimoni">Kata Santri</a></li>
  ...
  <section class="services" id="testimoni">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="section-heading">
            <h2>Kegiatan Santri & Santriwati</h2>
          </div>
        </div>
        <div class="col-lg-4">
        ...
        <div class="col-lg-8">
          <div class="row">
            <?php foreach ($dataTopLima as $i => $dt) :  ?>
              <div class="col-lg-6">
                <div class="meeting-item <?php echo $i == 0 ? "active" : ""; ?>" id="<?= $i + 1; ?>">
                  <div class=" thumb">
                    <div class="price">
                      <!-- <span>$22.00</span> -->
                    </div>
                    <a href="meeting-details.html"><img src="./public/assets/img/menu/<?= $dt['foto']; ?>" alt="New Lecturer Meeting"></a>
                  </div>
                  <div class="down-content">
                    <div class="date">
        ...
        <div class="col-lg-12">
          <div class="owl-courses-item owl-carousel">
            <?php foreach ($dataGallery as $dg) :  ?>
              <div class="item">
                <img src="./public/assets/img/gallery/<?= $dg['foto']; ?>" alt="Course One">
                <div class="down-content">
