...
<body>
  ...
  <section id="infinite" class="text-white tm-font-big tm-parallax">
    ...
    <div class="text-center tm-hero-text-container p-3">
      <div class="tm-hero-text-container-inner">
        <h2 class="tm-hero-title">PONDOK PESANTREN AL-HASAN</h2>
          ...
          <div class="tm-intro-text-container">
            ...
            <?php foreach ($data as $row) : ?>
              <p class="mb-4 tm-intro-text">
                <?= $row['deskripsi']; ?><a href="https://fb.com/tooplate">Tooplate Facebook page</a>.</p>
            <?php endforeach; ?>
          </div>
        </div>
